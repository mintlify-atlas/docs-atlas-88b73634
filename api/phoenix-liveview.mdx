...
<ParamField path="from" type="{pid, reference}">
...
<ResponseField name="return" type="{:noreply, socket} | {:reply, term, socket}">
...
<ResponseField name="return" type="{:noreply, socket}">
...
<ParamField path="reason" type=":normal | :shutdown | {:shutdown, reason}">
...
<ResponseField name="return" type="term">
...
<ParamField path="keys" type="atom | list | AsyncResult.t()">
  Async key(s) to cancel or an AsyncResult struct.
</ParamField>

<ParamField path="reason" type="term" default="{:shutdown, :cancel}">
...
<ResponseField name="return" type="term | nil">
